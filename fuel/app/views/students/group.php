<h1 class="page-header">Daftar Siswa Kelompok Peminatan <?php echo Uri::segment(3) ?></h1>
<?php if ($students == false): ?>
	<div class="alert alert-info">Belum ada siswa dalam Kelompok Peminatan ini. <?php echo Html::anchor('students/create', 'Tambahkan siswa', array('class' => 'alert-link')) ?> untuk menambahkan siswa.</div>
<?php else: ?>
